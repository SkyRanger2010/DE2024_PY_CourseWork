...
PYSPARK_SCRIPT_PATH = '/opt/airflow/scripts/pyspark_scripts/pyspark_mart_user_activity.py'
...
with DAG(
    'create_mart_user_activity',
    default_args=default_args,
    description='Создание витрины данных пользовательской активности в MySQL через Spark',
    ...
    spark_submit_task = SparkSubmitOperator(
        task_id=f'create_mart_user_activity',
