...
PYSPARK_SCRIPT_PATH = '/opt/airflow/scripts/pyspark_scripts/pyspark_mart_products_rating.py'
...
with DAG(
    'create_mart_products_rating',
    default_args=default_args,
    description='Создание витрины данных по рейтингу продуктов в MySQL через Spark',
    ...
    spark_submit_task = SparkSubmitOperator(
        task_id=f'create_mart_products_rating',
